...
interface Booking {
  ...
  status?: string;
  booking_type?: string; // This holds 'Scheduled' or 'Walk-in'
          ...
          {filteredBookings.length > 0 ? (
            <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
              <table className="w-full">
                ...
                <tr>
                    <th 
                    className="p-4 text-left text-xs font-bold text-slate-500 uppercase cursor-pointer hover:text-teal-600 whitespace-nowrap" 
